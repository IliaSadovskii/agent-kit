---
name: infra-local
description: Get the project running on a clean machine — containerize the backend, add build and run ergonomics, and wire any dev mobile build to the reachable local backend.
---
...
`${CLAUDE_PLUGIN_ROOT}/skills/infra-local/references/mobile-env.md`.
