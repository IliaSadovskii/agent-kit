...
| work understood and not done | `ship`, `fix` | a line in `docs/technical_debt.md` | the check counts it; `sprint` with no theme offers it | `ship`, `fix` — delete the line in the commit that does the work |
