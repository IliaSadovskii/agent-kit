...
class ChannelError(KitError):
    ...
    У ночи и у часа с владельцем этот код значит одно событие и две развилки,
    и обе надо знать. **Ночью** он не останавливает ничего: умолчание берётся,
    ...
    сохранён, и отказ называет, где он лежит.
    """
