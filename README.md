...
Three lenses so far: **scenarios** (walk each one step by step and name where the path breaks —
...
line names — and **deps** (vulnerable, dead or a major behind, interpreted for this codebase). Performance and security are designed and not written. Every run also
